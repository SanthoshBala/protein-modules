...
% Title
%title('Heart PPI Network Degree Distribution', 'fontname', 'Palatino', 'fontsize', 40);

% X Axis
xlabel('Degree, k', 'fontname', 'Palatino', 'fontsize', 20);

% Y Axis
ylabel('Degree Probability, P(k)', 'fontname', 'Palatino', 'fontsize', 20);
...
h = legend({'Data', '$P(k) = 0.777k^{-1.648}$'});
set(h, 'interpreter', 'latex', 'fontname', 'Palatino');

print(handle, '-depsc2', '-painters', strcat(PATH_TO_FIGURES, 'heart-degree-distribution.eps'));
