...
% Title
%title('Human PPI Module Protein Universality', 'fontname', 'Palatino', 'fontsize', 20);

% X Axis
xlabel('Protein Universality', 'fontname', 'Palatino', 'fontsize', 20);
% Y Axis
...
print(handle, '-depsc2', '-painters', strcat(PATH_TO_FIGURES, 'module-protein-universality.eps'));